...
/*   Updated: 2023/09/11 16:02:52 by tlegrand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void) : _name(""), _hp(10), _ep(10), _ad(0) {std::cout << "Default constructor called" << std::endl;};
...
void	ClapTrap::takeDamage(unsigned int amount) 
{
	...
	if (this->getHp() <= 0)
		std::cout << "ClapTrap " << this->_name << " has fallen amid the brave..." << std::endl;
};
...
void	ClapTrap::beRepaired(unsigned int amount) 
{
	...
	std::cout << "ClapTrap " << this->_name << " repaired itself and heal " << amount << " hit points." << std::endl;
	this->setHp(this->getHp() + amount);
	this->setEp(this->getEp() - 1);
};
